 ...
 */
public class Electrical extends Special{


  private final Integer max_employee = 4;
   ...
   */
  public Electrical(String address, PropertySize size, boolean carriedOutMonthly,
      int totalServicesDone, int number_employee, boolean complex) {
...
@Override
  public int getNumber_employee() throws IllegalServiceException{
    if(this.number_employee <= this.max_employee){
      return this.number_employee;
    }else{
      throw new IllegalServiceException("Can not creat electric service");
    }
